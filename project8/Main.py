...
def main():
    ...
    for vm_file in vm_files:
        ...
        # This ensures static variables (@FileName.i) are named correctly per file.
        clean_filename = os.path.splitext(os.path.basename(vm_file))[0]
        writer.setFileName(clean_filename)
